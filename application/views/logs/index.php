<h3><i class="fa fa-th-list"></i> Logs</h3>
<hr>
<div class="msg"></div>
<div id="toolbar">
...
<table
	...
	data-classes="table table-striped table-hover bootstrap-table table-condensed"
	...
	<thead>
		<tr>
			...
			<th data-field="mensagem" data-sortable="true">Mensagem</th>
			<th data-field="url" data-sortable="true">Url</th>
			<th data-field="data" data-sortable="true" data-formatter="formatter_datetime_to_br">Data</th>
			<th data-field="ip" data-sortable="true">Ip</th>
			<th data-field="browser" data-sortable="true" class="col-md-4">Navegador</th>
			<th data-field="acoes" data-align="center" data-formatter="formatter_actions" class="col-xs-3 col-md-1"><i class="fa fa-cogs"></i></th>
		</tr>
	</thead>
</table>
