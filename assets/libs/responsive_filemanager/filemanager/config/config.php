...
if(!$_SESSION['RF']['folder_base'])
{
	$_SESSION['RF']['folder_base']=$_GET['folder_base'];
}
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/'.$_SESSION['RF']['folder_base'].'/assets/uploads/filemanager/files/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../../../uploads/filemanager/files/',
